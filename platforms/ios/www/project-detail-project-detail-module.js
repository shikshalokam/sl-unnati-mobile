...
module.exports = ".project-detail {\n  background: #f7f7f7;\n  border-bottom: 2px solid #b23d33;\n  font-family: 'SourceSansPro-Bold';\n  font-weight: 600; }\n  .project-detail .label-box {\n    font-family: 'SourceSansPro-Bold';\n    font-weight: 600;\n    text-transform: uppercase; }\n  .project-detail ion-row {\n    padding: 5px 0px; }\n  .tasks-box {\n  background: #fff;\n  font-family: 'SourceSansPro-Bold';\n  font-weight: 600;\n  margin-bottom: 60px;\n  min-height: 45vh; }\n  .tasks-box .completed-task {\n    background: #2c8959;\n    color: #fff !important; }\n  .tasks-box .task-list {\n    border-bottom: 1px solid #b23d33;\n    padding: 5px 15px 5px 15px; }\n  .tasks-box .task-list .task-endDate {\n      font-size: 1.3em;\n      margin: auto;\n      color: #b23e33;\n      text-align: center; }\n  .tasks-box .tasks-label {\n    text-align: center; }\n  .tasks-box .tasks-label ion-icon {\n      font-size: 30px;\n      margin-top: -5px;\n      position: absolute;\n      margin-left: 12px; }\n  .custom-select {\n  border: 1px solid #ccc;\n  padding: 5px;\n  min-width: 70%;\n  max-width: 70%;\n  height: 36px;\n  border-radius: 4px; }\n  .prjdetail-btn {\n  margin-top: 20px;\n  margin-bottom: 0px;\n  font-size: 16px;\n  min-height: 36px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ProjectDetailPage = /** @class */ (function () {
    ...
    ProjectDetailPage.prototype.sortTasks = function () {
        ...
        this.project.tasks.forEach(function (task) {
            console.log(today >= task.endDate), "today <= task.endDate";
            if (task.endDate && !task.isDelete) {
                console.log(task.endDate, "in if");
                if (task.endDate >= today) {
                    console.log(task, "pushing into with date");
                    tasksWithEndDate.push(task);
                }
                else {
                    console.log(task, "pushing into without date");
        ...
        //   console.log(task.endDate, " <= ", today);
        //   console.log(new Date(task.endDate), " <= ", new Date(today));
        //   if (new Date(today) <= new Date(task.endDate)) {
        //     tasksWithEndDate.splice(tasksWithEndDate.indexOf(task), 1);
        //     tasksWithoutEndDate.push(task);
        //   }
        // });
