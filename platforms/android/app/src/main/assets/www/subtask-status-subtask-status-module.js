(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["subtask-status-subtask-status-module"],{
...
/*!*********************************************************!*\
  !*** ./src/app/subtask-status/subtask-status.module.ts ***!
  \*********************************************************/
/*! exports provided: SubtaskStatusPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SubtaskStatusPageModule", function() { return SubtaskStatusPageModule; });
...
/* harmony import */ var _subtask_status_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./subtask-status.page */ "./src/app/subtask-status/subtask-status.page.ts");
...
var routes = [
    {
        path: '',
        component: _subtask_status_page__WEBPACK_IMPORTED_MODULE_7__["SubtaskStatusPage"]
    }
];
var SubtaskStatusPageModule = /** @class */ (function () {
    function SubtaskStatusPageModule() {
    }
    SubtaskStatusPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_subtask_status_page__WEBPACK_IMPORTED_MODULE_7__["SubtaskStatusPage"]],
            providers: [_ionic_native_screen_orientation_ngx__WEBPACK_IMPORTED_MODULE_5__["ScreenOrientation"]]
        })
    ], SubtaskStatusPageModule);
    return SubtaskStatusPageModule;
}());
...
/***/ "./src/app/subtask-status/subtask-status.page.html":
/*!*********************************************************!*\
  !*** ./src/app/subtask-status/subtask-status.page.html ***!
  \*********************************************************/
...
module.exports = "<ion-header>\n  <ion-toolbar color=\"primary\">\n    <ion-buttons slot=\"start\">\n      <ion-back-button (click)=\"goBack()\"></ion-back-button>\n    </ion-buttons>\n    <ion-title style=\"  padding-left: 0px;\" *ngIf=\"task\">\n      <ion-item text-wrap style=\" --background: transparent;\n      color: #fff; --border-color: transparent;float: left;width: 100%;\">\n        <ion-grid>\n          <ion-row style=\"font-size: 1.3em;\">\n            <ion-col>\n              {{ task.title }}\n            </ion-col>\n          </ion-row>\n          <ion-row style=\"text-align:center; font-size: 14px;\">\n            <ion-col>Start date <br />\n              {{ task.startDate  | date :'dd-MM-yyyy'}}\n            </ion-col>\n            <ion-col> Status <br />\n              {{ task.status }}\n            </ion-col>\n            <ion-col>End date<br />\n              {{ task.endDate  | date :'dd-MM-yyyy' }}\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-item>\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n<ion-content>\n  <div *ngIf=\"task && task.subTasks\">\n    <ion-card *ngFor=\"let subtask of task.subTasks; let i = index\" style=\"background:#f2eded;\">\n      <ion-card-content>\n        <ion-grid>\n          <ion-row>\n            <ion-col> {{ i + 1 }} &nbsp; &nbsp; {{ subtask.title }}</ion-col>\n            <ion-col *ngIf=\"subtask.status\" style=\"max-width: 40%\">\n              <p class=\"status notyetstarted\" *ngIf=\"\n                  subtask.status == 'not yet started'\">\n                {{ subtask.status }}\n              </p>\n              <p class=\"status inprogress\" *ngIf=\"subtask.status == 'in progress'\">\n                {{ subtask.status }}\n              </p>\n              <p class=\"status completed\" *ngIf=\"subtask.status == 'completed'\">\n                {{ subtask.status }}\n              </p>\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-card-content>\n    </ion-card>\n  </div>\n  <ion-card *ngIf=\"task && !task.subTasks\">\n    <ion-card-header> </ion-card-header>\n    <ion-card-content>\n      No Subtasks are created for this Task.\n    </ion-card-content>\n  </ion-card>\n</ion-content>"

/***/ }),

/***/ "./src/app/subtask-status/subtask-status.page.scss":
/*!*********************************************************!*\
  !*** ./src/app/subtask-status/subtask-status.page.scss ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = ".status {\n  float: right;\n  padding: 0px 10px 0px 10px;\n  border-radius: 6px; }\n\n.inprogress {\n  background: #fdab8c;\n  color: #ccc; }\n\n.completed {\n  background: #ab2923;\n  color: #fff; }\n\n.notyetstarted {\n  background: #c4c3c3;\n  color: #000; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/subtask-status/subtask-status.page.ts":
/*!*******************************************************!*\
  !*** ./src/app/subtask-status/subtask-status.page.ts ***!
  \*******************************************************/
/*! exports provided: SubtaskStatusPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SubtaskStatusPage", function() { return SubtaskStatusPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var SubtaskStatusPage = /** @class */ (function () {
    function SubtaskStatusPage(storage, router, activatedRoute, screenOrientation) {
        var _this = this;
    ...
    SubtaskStatusPage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('currentProject').then(function (cp) {
            cp.projects.forEach(function (project) {
                _this.projectId = project._id;
                project.tasks.forEach(function (task) {
                    if (task._id == _this.taskId) {
                        _this.task = task;
                    }
                });
            });
    ...
    SubtaskStatusPage.prototype.ionViewDidEnter = function () {
        try {
    ...
    SubtaskStatusPage.prototype.goBack = function () {
        //  this.location.back();
    ...
    SubtaskStatusPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-subtask-status',
            template: __webpack_require__(/*! ./subtask-status.page.html */ "./src/app/subtask-status/subtask-status.page.html"),
            styles: [__webpack_require__(/*! ./subtask-status.page.scss */ "./src/app/subtask-status/subtask-status.page.scss")]
        }),
...
//# sourceMappingURL=subtask-status-subtask-status-module.js.map