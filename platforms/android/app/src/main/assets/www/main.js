...
var map = {
	...
	"../charts/charts.module": [
		...
		"default~charts-charts-module~detail-detail-module~subtask-view-subtask-view-module~subtasks-subtasks~9c8acac2",
	...
	"../tutorial-videos/tutorial-videos.module": [
		"./src/app/tutorial-videos/tutorial-videos.module.ts",
		"tutorial-videos-tutorial-videos-module"
	],
...
/* harmony import */ var _api_api__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./api/api */ "./src/app/api/api.ts");
/* harmony import */ var _app_project_view_project_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../app/project-view/project.service */ "./src/app/project-view/project.service.ts");
...
/* harmony import */ var _notification_card_notification_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./notification-card/notification.service */ "./src/app/notification-card/notification.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(storage, fcm, projectsService, alertController, router, menuCtrl, platform, splashScreen, statusBar, loginService, translate, network, mySchoolsService, networkService, modalController, route, projectService, api, homeService, loadingController, toastService, categoryViewService, notificationCardService) {
        var _this = this;
        this.storage = storage;
        this.fcm = fcm;
        ...
        this.interval = Object(rxjs__WEBPACK_IMPORTED_MODULE_14__["interval"])(3600000);
        this.loggedIn = false;
        this.appPages = [];
        this.history = [];
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.networkService.setLang('en');
            ...
            _this.platform.backButton.subscribeWithPriority(9999, function () {
                ...
                else if (_this.router.url == '/project-view/subtask-view') {
    ...
    AppComponent.prototype.prepareMappedProjectToSync = function () {
        ...
        this.storage.get('latestProjects').then(function (myProjects) {
            if (myProjects) {
                ...
                if (!_this.mappedProjectsToSync && !_this.myProjectsToSync) {
                    _this.toastService.successToast('message.already_sync');
                }
            }
        });
    ...
    AppComponent.prototype.syncUpdateInLocal = function (syncedProjects) {
        var _this = this;
        syncedProjects.forEach(function (projects) {
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_11__["Storage"],
            _fcm__WEBPACK_IMPORTED_MODULE_19__["FcmProvider"],
            ...
            _home_home_service__WEBPACK_IMPORTED_MODULE_17__["HomeService"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"],
            _toast_service__WEBPACK_IMPORTED_MODULE_18__["ToastService"],
            _category_view_category_view_service__WEBPACK_IMPORTED_MODULE_10__["CategoryViewService"],
            _notification_card_notification_service__WEBPACK_IMPORTED_MODULE_21__["NotificationCardService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @ionic-native/file-opener/ngx */ "./node_modules/@ionic-native/file-opener/ngx/index.js");
/* harmony import */ var _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! @ionic-native/fcm/ngx */ "./node_modules/@ionic-native/fcm/ngx/index.js");
/* harmony import */ var _fcm__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./fcm */ "./src/app/fcm.ts");
...
/* harmony import */ var _ionic_native_badge_ngx__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! @ionic-native/badge/ngx */ "./node_modules/@ionic-native/badge/ngx/index.js");
/* harmony import */ var _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! @ionic-native/social-sharing/ngx */ "./node_modules/@ionic-native/social-sharing/ngx/index.js");
...
/* harmony import */ var _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @ionic-native/file/ngx */ "./node_modules/@ionic-native/file/ngx/index.js");
/* harmony import */ var _ionic_native_file_chooser_ngx__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! @ionic-native/file-chooser/ngx */ "./node_modules/@ionic-native/file-chooser/ngx/index.js");
/* harmony import */ var _ionic_native_file_path_ngx__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! @ionic-native/file-path/ngx */ "./node_modules/@ionic-native/file-path/ngx/index.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _ionic_native_app_launcher_ngx__WEBPACK_IMPORTED_MODULE_20__["AppLauncher"],
                _app_api_api__WEBPACK_IMPORTED_MODULE_23__["ApiProvider"],
                _ionic_native_market_ngx__WEBPACK_IMPORTED_MODULE_21__["Market"],
                _ionic_native_date_picker_ngx__WEBPACK_IMPORTED_MODULE_24__["DatePicker"],
                _angular_common__WEBPACK_IMPORTED_MODULE_25__["DatePipe"],
                _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_32__["SocialSharing"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_6__["SplashScreen"],
                _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_33__["FileTransfer"],
                _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_33__["FileTransferObject"],
                _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_34__["File"],
                _ionic_native_file_chooser_ngx__WEBPACK_IMPORTED_MODULE_35__["FileChooser"],
                _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_26__["Camera"],
                _ionic_native_file_path_ngx__WEBPACK_IMPORTED_MODULE_36__["FilePath"],
                _ionic_native_app_version_ngx__WEBPACK_IMPORTED_MODULE_38__["AppVersion"],
...
var CustomPopupComponent = /** @class */ (function () {
    ...
    CustomPopupComponent.prototype.ngOnInit = function () {
        ...
        if (this.appUpdate) {
            ...
            this.translate.get([this.button]).subscribe(function (text) {
    ...
    CustomPopupComponent.prototype.openApp = function () {
        var _this = this;
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], CustomPopupComponent.prototype, "appUpdate", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], CustomPopupComponent.prototype, "showUpdatePopup", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Boolean)
...
module.exports = ".dot {\n  width: 20px;\n  min-width: 20px;\n  height: 20px;\n  background: red;\n  border-radius: 50%;\n  position: absolute;\n  right: 53px;\n  z-index: 2;\n  -webkit-box-pack: center;\n  justify-content: center;\n  color: #fff;\n  font-size: 11px;\n  font-weight: bold;\n  text-align: center;\n  padding: 3px; }\n\n.relative {\n  position: relative; }\n\n.notificationIcon {\n  font-size: 28px;\n  margin-right: 5px; }\n\n.margin {\n  margin: 0 8px !important; }\n\n.textCapital {\n  text-transform: capitalize; }\n\n.tab-selected, .activated {\n  border-bottom: 4px solid #fff !important; }\n\nion-tab-button ion-label {\n  font-size: 16px !important; }\n\n.header-action-icons {\n  font-size: 28px;\n  padding-left: 15px;\n  float: left; }\n\n.header-md:after {\n  height: 0px !important; }\n\n.ios-header {\n  padding-bottom: 30px;\n  margin-bottom: 30px; }\n\n.header-custom .header-custom-android {\n  padding-bottom: 0px;\n  margin-bottom: 0px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _network_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../network.service */ "./src/app/network.service.ts");
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(router, notificationCardService, storage, platform, menuController, badge, api, homeService, updateProfileService, networkService) {
        var _this = this;
        this.router = router;
        this.notificationCardService = notificationCardService;
        this.storage = storage;
    ...
    HeaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            ...
            _network_service__WEBPACK_IMPORTED_MODULE_10__["NetworkService"]])
    ], HeaderComponent);
...
module.exports = ".dot {\n  width: 10px;\n  height: 10px;\n  margin-right: 10px;\n  background-color: #b23d33;\n  border-radius: 50%; }\n\n.notificationCard {\n  border-radius: 15px;\n  margin: 15px 0;\n  box-shadow: 0px 6px 5px rgba(0, 0, 0, 0.16);\n  padding: 5px 30px; }\n\n.custom-list {\n  --background: transparent;\n  --border-color: transparent; }\n\n.inactiveDot {\n  background-color: #000; }\n\n.action-notifications {\n  text-align: center; }\n\n.old-notification {\n  background: #ebebeb;\n  color: #000;\n  padding: 10px 25px; }\n\n.new-notification {\n  background: #b23d33;\n  color: #fff;\n  padding: 10px 25px; }\n\n.notificationTitle {\n  font-family: 'Source Sans Pro', sans-serif !important;\n  -webkit-box-pack: justify;\n  justify-content: space-between;\n  font-size: 14px;\n  font-weight: 600;\n  padding-bottom: 5px; }\n\n.container {\n  padding: 0 15px !important; }\n\n.errorContainer {\n  padding: 0 15px !important;\n  height: 80vh !important; }\n\n.childContainer {\n  text-align: center; }\n\n.time {\n  color: #080808;\n  font-size: 12px; }\n\n.time-ago {\n  color: #000; }\n\n.errorMessage {\n  color: #080808; }\n\n.vertical-align-text {\n  margin: 0;\n  top: 50%;\n  -webkit-transform: translateY(-50%);\n          transform: translateY(-50%);\n  text-align: center;\n  margin: 0px 26px;\n  font-weight: 500; }\n\n.custom-title-col {\n  float: left;\n  max-width: 60% !important;\n  min-width: 60% !important;\n  padding: 0px !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".avatar-style {\n  margin: auto;\n  text-align: center;\n  font-size: 1.4em;\n  color: #727272;\n  margin-top: 8px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _category_view_category_view_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../category-view/category.view.service */ "./src/app/category-view/category.view.service.ts");
/* harmony import */ var _create_project_create_project_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../create-project/create-project.service */ "./src/app/create-project/create-project.service.ts");
/* harmony import */ var _ionic_storage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic/storage */ "./node_modules/@ionic/storage/fesm5/ionic-storage.js");
...
/* harmony import */ var _project_view_project_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../project-view/project.service */ "./src/app/project-view/project.service.ts");
...
var PopoverComponent = /** @class */ (function () {
    function PopoverComponent(translateService, popoverController, categoryViewService, createProjectService, storage, toastService, alertController, apiProvider, projectService, transfer, file, platform, socialSharing, fileChooser, base64, loadingController) {
    ...
    PopoverComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.platform.ready().then(function () {
            _this.projectToSync.push(_this.project);
    ...
    PopoverComponent.prototype.syncProject = function () {
        ...
        if (this.projectToSync[0].isEdited || this.projectToSync[0].isNew) {
            ...
            if (this.projectToSync[0].tasks && this.projectToSync[0].tasks.length > 0) {
                this.projectToSync[0].tasks.forEach(function (task) {
                    if (task.isNew) {
                        delete task._id;
                    }
                    if (task.subTasks && task.subTasks.length > 0) {
    ...
    PopoverComponent.prototype.syncUpdateInLocal = function (syncedProjects) {
        syncedProjects.forEach(function (projects) {
            projects.projects.forEach(function (sproject) {
                sproject.isNew = false;
                sproject.isSync = true;
    ...
    PopoverComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"],
            ...
            _category_view_category_view_service__WEBPACK_IMPORTED_MODULE_4__["CategoryViewService"],
            _create_project_create_project_service__WEBPACK_IMPORTED_MODULE_5__["CreateProjectService"],
            ...
            _project_view_project_service__WEBPACK_IMPORTED_MODULE_9__["ProjectService"],
...
var ProjectsService = /** @class */ (function () {
    function ProjectsService(api, http, currentUser, storage) {
        this.api = api;
        this.http = http;
        this.currentUser = currentUser;
        this.storage = storage;
...
var ToastService = /** @class */ (function () {
    ...
    ToastService.prototype.errorToast1 = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
module.exports = __webpack_require__(/*! /Users/vishwanathbadiger/Documents/apps/unnati-mobile-application/sl-unnati-mobile/src/main.ts */"./src/main.ts");
