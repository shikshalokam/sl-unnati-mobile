...
var CurrentTaskViewPage = /** @class */ (function () {
    function CurrentTaskViewPage(storage, datepipe, datePicker, router, route, createProjectService, toastService) {
        var _this = this;
    ...
    CurrentTaskViewPage.prototype.showToast = function () {
