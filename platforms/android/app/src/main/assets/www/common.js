...
/***/ "./src/app/create-task/create-task.service.ts":
/*!****************************************************!*\
  !*** ./src/app/create-task/create-task.service.ts ***!
  \****************************************************/
...
var CreateTaskService = /** @class */ (function () {
    ...
    CreateTaskService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])
...
var ReportsService = /** @class */ (function () {
    function ReportsService(api, http, currentUser, storage) {
        this.api = api;
        this.http = http;
        this.currentUser = currentUser;
        this.storage = storage;
    }
    ReportsService.prototype.getReports = function (data, limit, page) {
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-auth-token': data
        });
        return this.http.get(_app_config__WEBPACK_IMPORTED_MODULE_5__["AppConfigs"].api_url + '/unnati/api/v1/reports/reportsList?limit=100&page=0&search=' + limit + '&page=' + page, { headers: httpHeaders });
    };
    ReportsService.prototype.getReportFile = function (data, id) {
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-auth-token': data
        });
        return this.http.get(_app_config__WEBPACK_IMPORTED_MODULE_5__["AppConfigs"].api_url + '/unnati/api/v1/reports/getObservationReport?observationId=' + id, { headers: httpHeaders });
    };
    //  search reports
    ReportsService.prototype.searchReports = function (data, keyword) {
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-auth-token': data
        });
        return this.http.get(_app_config__WEBPACK_IMPORTED_MODULE_5__["AppConfigs"].api_url + '/unnati/api/v1/reports/reportsList?limit=100&page=0&search=' + keyword, { headers: httpHeaders });
    };
