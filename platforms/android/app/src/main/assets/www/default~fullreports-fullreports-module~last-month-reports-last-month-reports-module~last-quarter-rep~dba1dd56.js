(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~fullreports-fullreports-module~last-month-reports-last-month-reports-module~last-quarter-rep~dba1dd56"],{
...
/***/ "./src/app/my-reports/my-reports.service.ts":
/*!**************************************************!*\
  !*** ./src/app/my-reports/my-reports.service.ts ***!
  \**************************************************/
/*! exports provided: MyReportsService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyReportsService", function() { return MyReportsService; });
...
var MyReportsService = /** @class */ (function () {
    function MyReportsService(api, http, currentUser, storage) {
        this.api = api;
        this.http = http;
        this.currentUser = currentUser;
        this.storage = storage;
    }
    MyReportsService.prototype.getReports = function (data, state) {
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-auth-token': data
        });
        return this.http.get(_app_config__WEBPACK_IMPORTED_MODULE_5__["AppConfigs"].api_url + '/unnati/api/v1/reports/getMonthViseReport?reportType=' + state, { headers: httpHeaders });
    };
    MyReportsService.prototype.getFullReports = function (token, state) {
        var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
            'x-auth-token': token
        });
...
//# sourceMappingURL=default~fullreports-fullreports-module~last-month-reports-last-month-reports-module~last-quarter-rep~dba1dd56.js.map