...
var UpdateProfilePage = /** @class */ (function () {
    function UpdateProfilePage(formBuilder, updateProfileService, storage, api, toastService, router, notificationCardService) {
                        ...
                        if (parsedData && parsedData.access_token) {
                            ...
                            _this.storage.set('userTokens', userTokens_3).then(function (data) {
                                _this.updateProfileService.saveInfo(userTokens_3.access_token, _this.profile).subscribe(function (data) {
                                    _this.storage.get('clearNotification').then(function (data) {
                                        console.log(data, "data");
                                        _this.markAsRead(data);
                                    });
                                    _this.toastService.stopLoader();
    ...
    UpdateProfilePage.prototype.markAsRead = function (notificationMeta) {
        var _this = this;
            ...
            _this.api.refershToken(data.refresh_token).subscribe(function (data) {
                ...
                if (parsedData && parsedData.access_token) {
                    ...
                    _this.storage.set('userTokens', userTokens_4).then(function (usertoken) {
                        _this.notificationCardService.markAsRead(userTokens_4.access_token, notificationMeta.id).subscribe(function (data) {
                            notificationMeta.is_read = true;
                            console.log(data, "resp");
                            _this.notificationCardService.checkForNotificationApi(userTokens_4.access_token).subscribe(function (data1) {
    ...
    UpdateProfilePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            ...
            _notification_card_notification_service__WEBPACK_IMPORTED_MODULE_9__["NotificationCardService"]])
    ], UpdateProfilePage);
